...
{
	A user familiar with performing distance sampling analyses in the Distance GUI can use \texttt{converted\_distance\_analysis} objects to learn how to perform corresponding analyses using the \texttt{mrds} R package.  Alternatively, the imported data can be analysed using the \texttt{Distance} \citep{Miller2018} package.  Examples of both approaches provided below
